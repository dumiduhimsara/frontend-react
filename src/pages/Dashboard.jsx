...
const Dashboard = () => {
    ...
    const upcomingReminders = customers.filter(customer => {
        ...
        const dDate = new Date(customer.dueDate);
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex overflow-hidden">
            {/* Sidebar code... (No changes needed here) */}
            ...
            <main className="flex-1 flex flex-col h-screen overflow-y-auto">
                <header className="bg-white border-b border-slate-200 p-6 flex justify-between items-center sticky top-0 z-10 text-left">
                ...
                <div className="p-4 md:p-8 pb-10">
                    ...
                    {/* ✅ විසඳුම 3: නියමිත දිනට ණය නොගෙවූ අයට (Overdue) - SMS & WhatsApp දෙකම එකතු කළා */}
                                    ...
                                    <div key={c._id} className="flex items-center justify-between p-4 bg-white rounded-2xl border border-red-200">
                                        ...
                                        <div className="flex gap-2">
                                            {remindedCustomers.includes(c._id) ? (
                                                <span className="text-[10px] font-bold text-emerald-600 bg-emerald-50 px-3 py-2 rounded-xl flex items-center gap-1 animate-in fade-in zoom-in duration-300">මතක් කළා ✅</span>
                                            ) : (
                                                <>
                    ...
                    <div className="mb-6">
                        <input 
                            ...
                            className="w-full px-5 py-4 bg-white border border-slate-200 rounded-2xl focus:ring-2 focus:ring-blue-600 outline-none font-medium shadow-sm transition-all text-left"
                            value={searchTerm}
                            ...
                            <div key={customer._id} className="relative bg-white p-6 rounded-[28px] border border-slate-100 shadow-sm hover:shadow-md transition-all text-left group">
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <div className="text-right">
                                        {/* ✅ විසඳුම 1: ණය පියවා වැඩිපුර ඇති විට "කඩේ ගාව ඇති මුදල" කොළ පාටින් පෙන්වීම */}
            ...
            {/* Modal for managing debt... (Unchanged) */}
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[70] flex items-center justify-center p-4">
                    <div className="bg-white w-full max-w-sm rounded-[32px] p-8 shadow-2xl animate-in zoom-in duration-200">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <button onClick={() => setSelectedCustomer(null)} className="p-2 bg-slate-100 rounded-full text-slate-400 hover:bg-slate-200"><X size={20}/></button>
                        </div>
